...
function Copyright(props) {
  return (
    <Typography variant="body2" color="white" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" href="https://safwanali.netlify.app/home" sx={{textDecoration:'none'}}>
        Safwan
      </Link>{' '}
    ...
    <ThemeProvider theme={defaultTheme}>
      ...
      <Grid container component="main" sx={{
        ...
        <Grid
          ...
          md={7}
        />
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} sx={{backgroundColor:'rgba( 0, 0, 0,0.7)',color:'white'}}>
          <Box
            sx={{
              my: 8,
              mx: 4,
          ...
          >
            <Avatar src={Logo} sx={{ width: 200, height: 70 ,mb:3,borderRadius:0}}> 
            </Avatar>
            <Typography component="h1" variant="h5" sx={{cursor:"pointer",mr:1}} onClick={()=>{
                handlestate();
            }}>
              {state?"Login":"Sign in"}
            </Typography>
      ...
      />
              ...
              <Grid container>
                ...
                handlestate();
                    ...
                    {state?"Don't have an account? Sign Up":"Already have an account? Login"}
                  </Typography>
                </Grid>
              </Grid>
              <Copyright sx={{ mt: 5 }} />
